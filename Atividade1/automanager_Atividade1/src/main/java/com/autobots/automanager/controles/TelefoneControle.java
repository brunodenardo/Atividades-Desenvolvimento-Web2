...
public class TelefoneControle {
	...
	public Telefone pegarTelefone(@PathVariable Long telefone_id) {
		Telefone telefone = telefone_repositorio.findById(telefone_id).get();
		return telefone;
	}
	
	@GetMapping("/porCliente/{cliente_id}")
	public List<Telefone> pegarTelefonesCliente(@PathVariable Long cliente_id) {
	...
	public void cadastrarTelefone(@PathVariable Long cliente_id, @RequestBody Telefone telefone) {
		Cliente cliente = cliente_repositorio.findById(cliente_id).get();
	...
	@Transactional
	@PutMapping
	public void atualizaTelefone(@RequestBody Telefone telefoneAtualizacao) {
	...
	public void deletaTelefone(@PathVariable Long telefone_id, @PathVariable Long cliente_id) {
		Telefone telefone = telefone_repositorio.findById(telefone_id).get();
		Cliente cliente = cliente_repositorio.findById(cliente_id).get();
